CC=gcc
#CFLAGS=-std=c99 -g -Og -pedantic -Wall -Wextra -Wno-unused-variable -Werror=vla -Werror=strict-prototypes
CFLAGS=-std=c99 -O2 -pedantic -Wall -Wextra -Wno-unused-variable -Werror=vla -Werror=strict-prototypes
